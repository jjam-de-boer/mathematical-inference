...
/-!
Coordinate-preserving compiled prefixes, execution traces, and endpoint
semantics for atomic interventions.

Compilation that produces an `Execution` lives here because it depends on the
coordinate maps and realization records.
-/
