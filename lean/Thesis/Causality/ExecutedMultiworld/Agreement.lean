...
theorem executedRoutes_eventProbability_equiv
    ...
    QProb.Equiv
      ...
      (fromEmpty.endpointRecord.observedValue
        (fromEmpty.endpointEvent predicate)) :=
  MultiworldEndpoint.eventProbability_equiv
    fromFactual.sharedEndpoint fromEmpty.sharedEndpoint predicate
...
theorem executedRoutes_denominator_equiv
  ...
  MultiworldEndpoint.pair_denominator_equiv query
    fromFactual.sharedEndpoint fromEmpty.sharedEndpoint
...
theorem executedRoutes_numerator_equiv
  ...
  MultiworldEndpoint.pair_numerator_equiv query
    fromFactual.sharedEndpoint fromEmpty.sharedEndpoint
...
noncomputable def executedRoutes_denote_equivalent
  ...
  MultiworldEndpoint.pair_denote_equivalent query
    fromFactual.sharedEndpoint fromEmpty.sharedEndpoint
